 ...
 */
@Component(name = "GraphAnnoManipulatorComponent", factory = "PepperManipulatorComponentFactory")
public class GraphAnnoManipulator extends PepperManipulatorImpl {
	// =================================================== mandatory
	// ===================================================
	/**
	 ...
	 * module unique.
	 */
	public GraphAnnoManipulator() {
		super();
		setName("GraphAnnoManipulator");
	 ...
	 */
	public static class GraphAnnoMapper extends PepperMapperImpl implements GraphTraverseHandler {
		/**
		...
		public DOCUMENT_STATUS mapSDocument() {
			...
			// depth-first order top down. The id 'GraphAnnoTraversal' is used for
			...
			getDocument().getDocumentGraph().traverse(roots, GRAPH_TRAVERSE_TYPE.TOP_DOWN_DEPTH_FIRST, "GraphAnnoTraversal", this);
