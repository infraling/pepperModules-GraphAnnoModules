/*******************************************************************************
 * Copyright 2016 Friedrich-Schiller-Universität Jena, Humboldt-Universität zu Berlin
 *
 ...
 *******************************************************************************/
package org.corpus_tools.peppermodules.graphanno;
...
public class GraphAnnoImporter extends PepperImporterImpl implements PepperImporter{
	/** this is a logger, for recording messages during program process, like debug messages**/
	private static final Logger logger = LoggerFactory.getLogger(GraphAnnoImporter.class);
	 ...
	 * sample mapper of type {@link GraphAnnoMapper}, which only produces a fixed
	 * document-structure in method {@link GraphAnnoMapper#mapSDocument()} and
	 * enhances the corpora for further meta-annotations in the method
	 * {@link GraphAnnoMapper#mapSCorpus()}. <br/>
	...
	public PepperMapper createPepperMapper(Identifier Identifier) {
		GraphAnnoMapper mapper = new GraphAnnoMapper();
		/**
	 ...
	 * {@link GraphAnnoMapper#mapSDocument()} and enhances the corpora for further
	 * meta-annotations in the method {@link GraphAnnoMapper#mapSCorpus()}. <br/>
