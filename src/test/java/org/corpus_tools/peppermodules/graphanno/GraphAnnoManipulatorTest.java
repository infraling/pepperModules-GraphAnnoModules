...
import org.corpus_tools.peppermodules.graphanno.GraphAnnoManipulator;
 ...
 * {@link GraphAnnoManipulator} class. Feel free to adapt and enhance this test
 ...
 */
public class GraphAnnoManipulatorTest extends PepperManipulatorTest {
	/**
	...
	@Before
	public void setUp() {
		setFixture(new GraphAnnoManipulator());
	}
