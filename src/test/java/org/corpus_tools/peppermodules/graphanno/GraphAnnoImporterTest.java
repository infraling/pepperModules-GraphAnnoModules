...
import org.corpus_tools.peppermodules.graphanno.GraphAnnoImporter;
 ...
 * {@link GraphAnnoImporter} class. Feel free to adapt and enhance this test class
...
public class GraphAnnoImporterTest extends PepperImporterTest {
	...
	public void test_DummyImplementation() {
		...
		getFixture().getCorpusDesc().setCorpusPath(getTempURI("GraphAnnoImporter"));
